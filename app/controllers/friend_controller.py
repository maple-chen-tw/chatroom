...
@router.get("/{user_id}/friends/requests/pending", response_model=list[dto.Friend])
...
# get sent requests
@router.get("/{user_id}/friends/requests/sent", response_model=list[dto.Friend])
...
@router.post("/{user_id}/friends/requests/accepted")
